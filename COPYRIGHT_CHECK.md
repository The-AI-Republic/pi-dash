...
To verify that all tracked Python files contain the correct copyright header for **Pi Dash Software Inc.** for the year **2023**, run this command from the repository root:
...
- **`-c "Pi Dash Software Inc."`**: sets the copyright holder.
