...
import type { IPublicIssue, TIssuePublicComment, TPublicIssuesResponse } from "@apple-pi-dash/types";
// api service
import { APIService } from "../api.service";

/**
 * Service class for managing issues within apple pi dash sites application
