...
export class AssistantService extends APIService {
   ...
   * the recognized text. The field name is `file`, matching both the backend
   * view and the OpenAI-compatible transcription contract. On failure the
   * rejected value is the API error body (e.g. `{ error: "stt_config_missing" }`)
