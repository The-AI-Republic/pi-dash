...
export default {
  ...
  project_settings: {
    ...
    states: {
      ...
      members_edit: {
        toast: {
          loading: "Обновление настройки проекта...",
          success_title: "Успешно!",
          success_message: "Настройка проекта обновлена.",
          error_title: "Ошибка!",
          error_message: "При обновлении настройки проекта произошла ошибка. Пожалуйста, попробуйте снова.",
        },
        title: "Разрешить участникам редактировать статусы",
        description:
          "Если включено, участники проекта могут добавлять, редактировать, изменять порядок и удалять статусы рабочего процесса. Если отключено, только администраторы могут управлять статусами.",
      },
    },
    labels: {
      heading: "Метки",
  ...
  scheduler_bindings: {
    ...
    toast: {
      updated_title: "Установка обновлена",
      enabled_message: "Планировщик включён — он сработает при следующем такте cron.",
      disabled_message: "Планировщик отключён — он не будет срабатывать до повторного включения.",
      error_title: "Что-то пошло не так",
      update_failed: "Не удалось обновить установку.",
      updated_message: "Последующие запуски используют новые настройки.",
      installed_title: "Планировщик установлен",
      installed_message: "Он будет срабатывать по настроенному cron.",
      install_failed: "Не удалось установить планировщик.",
      uninstalled_title: "Планировщик удалён",
      uninstalled_message: "Он не будет срабатывать в этом проекте до повторной установки.",
      uninstall_failed: "Не удалось удалить планировщик.",
    },
    list: {
      empty:
        "На этом проекте ещё не установлены планировщики. Нажмите «Установить планировщик», чтобы добавить его из каталога рабочего пространства.",
      none_yet: "(никогда)",
    },
    actions: {
    ...
    edit_modal: {
      title: "Редактировать установку планировщика",
      saving: "Сохранение…",
      save: "Сохранить",
    },
    install_modal: {
      cron_label: "Расписание (cron)",
      errors: {
        cron_required: "Требуется cron-выражение.",
        scheduler_required: "Выберите планировщик.",
      },
      cron_placeholder: "0 9 * * *",
      cron_help: "Cron-выражение из 5 полей в UTC, например ``0 9 * * *`` для 09:00 UTC каждый день.",
      extra_context_label: "Контекст проекта (необязательно)",
      extra_context_placeholder: "Заметки, специфичные для этого проекта…",
      extra_context_help:
        "Добавляется к базовому промпту планировщика во время выполнения. Используйте его, чтобы задать специфичный для проекта контекст, который не должен содержаться в промпте рабочего пространства.",
      enabled_label: "Включено",
      enabled_help: "Отключённые установки не срабатывают по cron до повторного включения.",
      cancel: "Отмена",
      none_available_title: "Нет доступных планировщиков",
      none_available_body:
        "Либо все планировщики рабочего пространства уже установлены в этом проекте, либо администратор рабочего пространства не включил ни одного. Перейдите в Рабочее пространство → Планировщики, чтобы управлять каталогом.",
      title: "Установить планировщик",
      scheduler_label: "Планировщик",
      scheduler_help:
    ...
    uninstall_modal: {
      ...
      body: "Планировщик перестанет срабатывать в этом проекте. Определение рабочего пространства не затрагивается, его можно будет переустановить позже.",
      confirm: "Удалить",
    },
  },
  prompts: {
    detail: {
      ...
      default_title: "Шаблон подсказки (по умолчанию Pi Dash)",
      workspace_title: "Шаблон подсказки (переопределение рабочего пространства)",
      default_description:
        "Это встроенный шаблон по умолчанию Pi Dash. Администраторы рабочего пространства не могут редактировать его здесь — настройте его для своего рабочего пространства, чтобы переопределить.",
      workspace_description:
        "Переопределение шаблона по умолчанию Pi Dash для вашего рабочего пространства. Изменения увеличивают версию и применяются к следующему запуску агента для этого рабочего пространства.",
      back: "Назад к списку",
      body: "Тело шаблона (Jinja + Markdown)",
      unsaved: "Несохраненные изменения",
      save: "Сохранить",
    },
    toast: {
      saved_title: "Подсказка сохранена",
      saved_message: "Последующие запуски агента будут использовать обновленную подсказку.",
      save_failed: "Не удалось сохранить подсказку.",
      error_title: "Что-то пошло не так",
      created_title: "Переопределение рабочего пространства создано",
      created_message:
        "Мы скопировали текущий шаблон по умолчанию Pi Dash. Отредактируйте и сохраните, чтобы настроить его.",
      customize_failed: "Не удалось создать переопределение рабочего пространства.",
      reverted_title: "Возвращено к шаблону по умолчанию Pi Dash",
      reverted_message: "Это рабочее пространство снова использует общий шаблон по умолчанию.",
      revert_failed: "Не удалось вернуть подсказку.",
    },
    preview: {
      missing_issue_id: "Сначала введите идентификатор задачи.",
      failed: "Ошибка рендеринга.",
      title: "Предпросмотр",
      issue_id_placeholder: "Идентификатор задачи (UUID)",
      run: "Предпросмотр",
      empty: "Вставьте идентификатор задачи и нажмите «Предпросмотр», чтобы отобразить шаблон для реальной задачи.",
      admin_only:
        "Предварительный просмотр отображаемой подсказки — это действие администратора рабочего пространства. Обратитесь к администратору рабочего пространства, если вам нужно увидеть её отображение для конкретной задачи.",
    },
    scope: {
      default: "Pi Dash по умолчанию",
      workspace: "Переопределение рабочего пространства",
    },
    title: "Подсказки",
    subtitle:
    ...
    customize: "Настроить для этого рабочего пространства",
    columns: {
      name: "Название",
      scope: "Область",
      version: "Версия",
    ...
    list: {
      empty: "Нет доступных шаблонов подсказок. Значение по умолчанию Pi Dash будет добавлено при следующей миграции.",
    },
    revert: {
      confirm_title: "Вернуть значение по умолчанию Pi Dash?",
      confirm_body:
        "Это архивирует ваш шаблон, привязанный к рабочему пространству. Новые запуски агентов в этом рабочем пространстве будут использовать значение по умолчанию Pi Dash, пока вы не создадите другое переопределение.",
      confirm: "Вернуть",
    },
    actions: {
      edit: "Редактировать",
      view: "Просмотреть",
      revert: "Вернуть по умолчанию",
    },
  },
  runners: {
    toast: {
    ...
    approvals: {
      decision_failed: "Не удалось записать решение",
      empty: "Нет ожидающих утверждений.",
      run_meta: "Запуск {runId} · запрошено {at}",
      expires: "истекает {at}",
      accept_once: "Принять один раз",
      accept_for_session: "Принять для сессии",
      decline: "Отклонить",
    },
    tabs: {
      runners: "AI-агенты",
    ...
    title: "AI-агенты",
    page_title: "{workspace} - AI-агенты",
    list: {
    ...
    pods: {
      title: "Группы",
      help: "Группы объединяют ваши раннеры. Задачи делегируются группе, и любой свободный раннер внутри берет на себя работу. Нажмите на плитку, чтобы отфильтровать раннеры.",
    ...
    add_modal: {
      ...
      pod_default_option: "(группа по умолчанию)",
    ...
    runs: {
      cancel_failed: "Не удалось отменить запуск",
      columns: {
        started: "Запущен",
        status: "Статус",
        prompt: "Запрос",
      ...
      select_run: "Выберите запуск слева.",
      cancel: "Отменить запуск",
      prompt: "Запрос",
      error: "Ошибка",
      done_payload: "Полезная нагрузка завершения",
      events_count: "События ({count})",
      event_columns: {
        seq: "seq",
        kind: "тип",
        at: "время",
      },
      cancel_confirm_title: "Отменить запуск?",
      cancel_confirm_body: "Исполнитель остановит этот запуск, как только получит сигнал.",
    },
    create_pod_modal: {
      errors: {
        create_failed: "Не удалось создать под.",
        project_required: "Выберите проект.",
        load_projects_failed: "Не удалось загрузить проекты.",
        name_required: "Имя обязательно.",
      },
      title: "Создать новый под",
      subtitle: "Поды группируют исполнителей в рамках проекта. Выберите проект, затем дайте поду имя.",
      project_label: "Проект",
      project_placeholder: "Выберите проект",
      project_help: "Проект, к которому относится этот под. Имя будет дополнено префиксом идентификатора проекта.",
      name_label: "Имя",
      name_placeholder: "beefy",
      name_help: "Буквы, цифры, дефисы и подчёркивания. Префикс проекта добавляется автоматически.",
      description_label: "Описание (необязательно)",
      description_placeholder: "Где работает этот под, для чего он и т.д.",
      cancel: "Отмена",
      submitting: "Создание…",
      submit: "Создать под",
    },
  ...
  schedulers: {
    toast: {
      created_title: "Планировщик создан",
      created_message: "Администраторы проектов теперь могут установить его в своих проектах.",
      create_failed: "Не удалось создать планировщик.",
      error_title: "Что-то пошло не так",
      updated_title: "Планировщик обновлён",
      updated_message: "Последующие запуски будут использовать обновлённое определение.",
      update_failed: "Не удалось обновить планировщик.",
      deleted_title: "Планировщик удалён",
      deleted_message: "Активные привязки перестали срабатывать.",
      delete_failed: "Не удалось удалить планировщик.",
    },
    title: "Планировщики",
    subtitle:
      "Многоразовые определения планировщиков для этого рабочего пространства. Установите один на проект, чтобы запускать его запрос по расписанию (cron).",
    new: "Новый планировщик",
    columns: {
      name: "Имя",
      slug: "Slug",
      source: "Источник",
    ...
    list: {
      empty: "В этой рабочей области пока нет планировщиков. Нажмите «Новый планировщик», чтобы создать его.",
      installs_count: "{count, plural, one {# установка} few {# установки} many {# установок} other {# установок}}",
    },
    source: {
      manifest: "Манифест",
      builtin: "Встроенный",
    ...
    delete: {
      confirm_title: "Удалить планировщик?",
      confirm_body:
        "Это мягко удаляет планировщик. Все активные привязки проектов перестанут срабатывать. Slug становится доступным для повторного создания.",
      confirm: "Удалить",
    },
    form: {
      edit_title: "Редактировать планировщик",
      create_title: "Новый планировщик",
      slug_label: "Slug",
      errors: {
        slug_required: "Slug обязателен.",
        name_required: "Имя обязательно.",
        prompt_required: "Подсказка обязательна.",
      },
      slug_placeholder: "security-audit",
      slug_help: "Идентификатор в нижнем регистре, используемый в URL. Не может быть изменён после создания.",
      name_label: "Имя",
      name_placeholder: "Security audit",
      description_label: "Описание",
      description_placeholder: "Краткое описание, отображаемое в выборе установки.",
      prompt_label: "Подсказка",
      prompt_placeholder: "Искать нерешенные проблемы безопасности в этом проекте…",
      prompt_help:
        "Базовый промпт, который агент выполняет каждый тик. Контекст для каждого проекта добавляется при установке, поэтому оставьте этот промпт независимым от проекта.",
      enabled_label: "Включено",
      enabled_help:
        "Отключенные планировщики не могут быть установлены на новые проекты, а существующие привязки не будут срабатывать.",
      cancel: "Отмена",
      saving: "Сохранение…",
      save: "Сохранить",
      creating: "Создание…",
      create: "Создать планировщик",
    },
  },
  date: "",
  epics: "",
