...
export default {
  ...
  schedulers: {
    ...
    form: {
      ...
      color_label: "Color",
      color_help: "Used to color this scheduler's blocks on the project calendar.",
      cancel: "Cancel",
      save: "Save",
  ...
  scheduler_bindings: {
    ...
    install_modal: {
      ...
      dtstart_label: "Starts at",
      dtstart_help: "First firing of this binding. The recurrence rule expands from here.",
      tzid_label: "Time zone",
      tzid_help: "Stored with the binding. Future PRs honour it for wall-clock-aware DST semantics.",
      rrule_label: "Recurrence (RRULE)",
      rrule_help:
        "RFC 5545 RRULE — e.g. ``FREQ=WEEKLY;BYDAY=MO,TU,WE,TH,FR``. Leave blank to fire only once at the start.",
      rrule_empty_help: "Fires once at the start time.",
      rrule_invalid_help: "Invalid RRULE — fix it before submitting.",
      ...
      enabled_label: "Enabled",
      enabled_help: "Disabled installs do not fire until re-enabled.",
      install: "Install",
      ...
      errors: {
        ...
        dtstart_required: "Start time is required.",
        tzid_required: "Time zone is required.",
      },
    },
    edit_modal: {
    ...
    toast: {
      ...
      installed_message: "It will fire on the configured schedule.",
      updated_title: "Install updated",
      updated_message: "Subsequent runs use the new settings.",
      enabled_message: "Scheduler enabled — it will fire on the next scheduled tick.",
    ...
    calendar: {
      ...
      month: "Month",
      week: "Week",
      rail_title: "Calendars",
      rail_empty: "Install a scheduler from the List tab to see it here.",
      show_all: "Show all",
      hide_all: "Hide all",
      too_many: "Too many occurrences in this window — narrow the date range to see all.",
      empty_title: "No schedulers installed",
      empty_body: "Install a scheduler from the List tab to see its occurrences on the calendar.",
      drawer: {
        past_title: "Past run",
        future_title: "Scheduled",
        when: "When",
        tz: "Time zone",
        status: "Status",
        recurrence: "Recurrence",
        context: "Project context",
        view_run: "View full run",
        edit: "Edit binding",
        cancel: "Close",
      },
    },
  ...
  runners: {
    ...
    pods: {
      title: "Pods",
      help: "Pods group your runners. Issues delegate to a pod, and any free runner inside picks up the work. Click a tile to filter runners.",
      empty: "No pods yet — your workspace pod will appear here.",
      default_badge: "default",
      runner_count: "{count} runner(s)",
      load_failed: "Failed to load pods",
      create_tile: "Create new pod",
      tile_aria: "Filter runners by pod {name}",
      filter_active: "Filtering runners by pod {name}",
      filter_clear: "Clear filter",
    },
    create_pod_modal: {
      title: "Create new pod",
      subtitle: "Pods group runners under a project. Pick a project, then give the pod a name.",
      project_label: "Project",
      project_help: "The project this pod belongs to. The name will be prefixed with the project identifier.",
      project_placeholder: "Select a project",
      name_label: "Name",
      name_help: "Letters, digits, dashes, and underscores. The project prefix is added automatically.",
      name_placeholder: "beefy",
      description_label: "Description (optional)",
      description_placeholder: "Where this pod runs, what it's for, etc.",
      submit: "Create pod",
      submitting: "Creating…",
      cancel: "Cancel",
      errors: {
        ...
        create_failed: "Could not create the pod.",
      },
    },
    add_modal: {
      title: "Add runner",
