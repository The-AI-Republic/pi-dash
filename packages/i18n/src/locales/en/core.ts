...
export default {
  ...
  issue_agent_status: {
    titles: {
      queued: "AI agent is queued",
      assigned: "AI agent is starting on this issue",
      running: "AI agent is working on this issue",
      awaiting_approval: "AI agent is waiting for approval",
      awaiting_reauth: "AI agent needs re-auth",
      paused_awaiting_input: "AI agent is waiting for input",
      blocked: "AI agent is blocked on this issue",
      failed: "AI agent run failed",
      cancelled: "AI agent run was cancelled",
      completed: "AI agent run completed",
      scheduled: "AI agent ticking is scheduled",
      disabled: "AI agent ticking is disabled",
      cap_hit: "AI agent run limit reached",
      off: "AI agent ticking is off",
    },
    badges: {
      queued: "Queued",
      assigned: "Assigned",
      ...
      awaiting_reauth: "Re-auth",
      paused_awaiting_input: "Paused",
      blocked: "Blocked",
      failed: "Failed",
      cancelled: "Cancelled",
      completed: "Done",
    ...
    details: {
      waiting_for_runner: "Waiting for an available runner.",
      runner: "Runner: {name}",
      latest_run_failed: "The latest run did not complete.",
      disabled: "Automatic runs are turned off for this issue.",
      waiting_for_next_tick: "Waiting for the next scheduled tick.",
      next_tick_in: "Next ticking in {nextTick}",
      run_done_one: "{count} run is done",
      run_done_many: "{count} runs are done",
      run_done_next_tick: "{runs}, next ticking in {nextTick}",
      tick_no_cap: "Tick {count}, no cap",
      tick_budget: "Tick {count} of {max}",
