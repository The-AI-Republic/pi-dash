...
export default {
  ...
  "AI agent run is in a retired state": "AI agent run is in a retired state",
  ...
  "Project Context (Will be shown to AI agents)": "Project Context (Will be shown to AI agents)",
