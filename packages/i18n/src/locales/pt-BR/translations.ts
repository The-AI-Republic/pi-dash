...
export default {
  ...
  auth: {
    common: {
      ...
      new_to_apple_pi_dash: "Novo no Apple Pi Dash?",
  ...
  support: "Suporte",
  forum: "Forum",
  powered_by_apple_pi_dash_pages: "Desenvolvido por Apple Pi Dash Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "A maioria das coisas começa com um projeto no Apple Pi Dash.",
        cta: "Começar",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Personalize o Apple Pi Dash.",
    ...
    new_at_apple_pi_dash: {
      title: "Novidades no Apple Pi Dash",
    },
    quick_tutorial: {
  ...
  workspace_creation: {
    ...
    subheading: "Para começar a usar o Apple Pi Dash, você precisa criar ou entrar em um espaço de trabalho.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Bem-vindo ao Apple Pi Dash, estamos animados por tê-lo aqui. Crie seu primeiro projeto e rastreie seus itens de trabalho, e esta página se transformará em um espaço que ajuda você a progredir. Os administradores também verão itens que ajudam sua equipe a progredir.",
        primary_button: {
          text: "Construa seu primeiro projeto",
          comic: {
            title: "Tudo começa com um projeto no Apple Pi Dash",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copie e salve esta chave secreta no Páginas do Apple Pi Dash. Você não pode ver esta chave depois de clicar em Fechar. Um arquivo CSV contendo a chave foi baixado.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Qualquer aplicativo que use este token não terá mais acesso aos dados do Apple Pi Dash. Esta ação não pode ser desfeita.",
          success: {
            title: "Sucesso!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "As APIs do Apple Pi Dash podem ser usadas para integrar seus dados no Apple Pi Dash com qualquer sistema externo. Crie um token para começar.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Comece criando um novo item de trabalho! Adicione detalhes e propriedades a ele. Explore mais no Apple Pi Dash para ver sua atividade.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "O Apple Pi Dash arquivará automaticamente os itens de trabalho que foram concluídos ou cancelados.",
        duration: "Arquivar automaticamente itens de trabalho que estão fechados por",
      },
      "auto-close": {
        title: "Fechar automaticamente itens de trabalho",
        description: "O Apple Pi Dash fechará automaticamente os itens de trabalho que não foram concluídos ou cancelados.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Os itens de trabalho são blocos de construção no Apple Pi Dash.",
            description:
              "Redesenhar a interface do usuário do Apple Pi Dash, reformular a marca da empresa ou lançar o novo sistema de injeção de combustível são exemplos de itens de trabalho que provavelmente têm subitens de trabalho.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Escreva uma nota, um documento ou uma base de conhecimento completa. Peça a Galileo, o assistente de IA do Apple Pi Dash, para ajudá-lo a começar",
        description:
          "As páginas são espaço para registrar pensamentos no Apple Pi Dash. Anote notas de reunião, formate-as facilmente, incorpore itens de trabalho, organize-os usando uma biblioteca de componentes e mantenha-os todos no contexto do seu projeto. Para facilitar qualquer documento, invoque Galileo, a IA do Apple Pi Dash, com um atalho ou o clique de um botão.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    apple_pi_dash_didnt_start_up_this_could_be_because_one_or_more_apple_pi_dash_services_failed_to_start:
      "O Apple Pi Dash não inicializou. Isso pode ser porque um ou mais serviços do Apple Pi Dash falharam ao iniciar.",
