...
export default {
  ...
  project_settings: {
    ...
    states: {
      ...
      members_edit: {
        toast: {
          loading: "Оновлення налаштування проєкту...",
          success_title: "Успіх!",
          success_message: "Налаштування проєкту оновлено.",
          error_title: "Помилка!",
          error_message: "Під час оновлення налаштування проєкту сталася помилка. Будь ласка, спробуйте ще раз.",
        },
        title: "Дозволити учасникам редагувати статуси",
        description:
          "Якщо ввімкнено, учасники проєкту можуть додавати, редагувати, змінювати порядок і видаляти статуси робочого процесу. Якщо вимкнено, лише адміністратори можуть керувати статусами.",
      },
    },
    labels: {
      heading: "Мітки",
  ...
  scheduler_bindings: {
    tab_label: "Планувальники",
    title: "Планувальники",
    subtitle:
      "Планувальники, встановлені в цьому проєкті. Кожне встановлення запускає свій запит до проєкту за налаштованим cron.",
    install: "Встановити планувальник",
    columns: {
      name: "Планувальник",
      cron: "Розклад",
    ...
    toast: {
      updated_title: "Встановлення оновлено",
      enabled_message: "Планувальник увімкнено — він спрацює на наступному такті cron.",
      disabled_message: "Планувальник вимкнено — він не спрацює, доки не буде ввімкнено знову.",
      error_title: "Щось пішло не так",
      update_failed: "Не вдалося оновити встановлення.",
      updated_message: "Наступні запуски використовують нові налаштування.",
      installed_title: "Планувальник встановлено",
      installed_message: "Він спрацьовуватиме за налаштованим cron.",
      install_failed: "Не вдалося встановити планувальник.",
      uninstalled_title: "Планувальник видалено",
      uninstalled_message: "Він не спрацьовуватиме в цьому проєкті, доки не буде перевстановлено.",
      uninstall_failed: "Не вдалося видалити планувальник.",
    },
    list: {
      empty:
        "У цьому проєкті ще не встановлено жодного планувальника. Натисніть «Встановити планувальник», щоб додати його з каталогу робочого простору.",
      none_yet: "(ніколи)",
    },
    actions: {
      disable: "Вимкнути планувальник",
      enable: "Увімкнути планувальник",
      edit: "Редагувати",
      uninstall: "Видалити",
    },
    status: {
    ...
    edit_modal: {
      title: "Редагувати встановлення планувальника",
      saving: "Збереження…",
      save: "Зберегти",
    },
    install_modal: {
      cron_label: "Розклад (cron)",
      errors: {
        cron_required: "Вираз cron є обов'язковим.",
        scheduler_required: "Виберіть планувальник.",
      },
      cron_placeholder: "0 9 * * *",
      cron_help: "5-пільний вираз cron у UTC, наприклад ``0 9 * * *`` для 09:00 UTC щодня.",
      extra_context_label: "Контекст проєкту (необов'язково)",
      extra_context_placeholder: "Нотатки, специфічні для цього проєкту…",
      extra_context_help:
        "Додається до базового запиту планувальника під час виконання. Використовуйте це, щоб надати специфічне для проєкту обрамлення, яке не повинен нести запит робочого простору.",
      enabled_label: "Увімкнено",
      enabled_help: "Вимкнені встановлення не спрацьовують за cron, доки не будуть увімкнені знову.",
      cancel: "Скасувати",
      none_available_title: "Немає доступних планувальників",
      none_available_body:
        "Або всі планувальники робочого простору вже встановлені в цьому проєкті, або ваш адміністратор робочого простору не ввімкнув жодного. Відвідайте Робочий простір → Планувальники, щоб керувати каталогом.",
      title: "Встановити планувальник",
      scheduler_label: "Планувальник",
      scheduler_help:
    ...
    uninstall_modal: {
      title: "Видалити планувальник?",
      body: "Планувальник перестає спрацьовувати в цьому проєкті. Визначення робочого простору не змінюється, і його можна буде перевстановити пізніше.",
      confirm: "Видалити",
    },
  },
  prompts: {
    detail: {
      ...
      default_title: "Шаблон підказки (типовий Pi Dash)",
      workspace_title: "Шаблон підказки (перевизначення робочого простору)",
      default_description:
        "Це вбудований типовий Pi Dash. Адміністратори робочого простору не можуть редагувати його тут — налаштуйте для свого робочого простору, щоб перевизначити.",
      workspace_description:
        "Перевизначення типового Pi Dash для вашого робочого простору. Редагування збільшує версію та застосовується до наступного запуску агента для цього робочого простору.",
      back: "Назад до списку",
      body: "Тіло шаблону (Jinja + Markdown)",
      unsaved: "Незбережені зміни",
      save: "Зберегти",
    },
    toast: {
      saved_title: "Підказку збережено",
      saved_message: "Наступні запуски агента використовуватимуть оновлену підказку.",
      save_failed: "Не вдалося зберегти підказку.",
      error_title: "Щось пішло не так",
      created_title: "Створено перевизначення робочого простору",
      created_message: "Ми скопіювали поточний типовий Pi Dash. Відредагуйте та збережіть, щоб налаштувати його.",
      customize_failed: "Не вдалося створити перевизначення робочого простору.",
      reverted_title: "Повернено до типового Pi Dash",
      reverted_message: "Цей робочий простір знову використовує спільний типовий шаблон.",
      revert_failed: "Не вдалося повернути підказку.",
    },
    preview: {
      missing_issue_id: "Спочатку введіть ідентифікатор завдання.",
      failed: "Не вдалося відобразити.",
      title: "Попередній перегляд",
      issue_id_placeholder: "Ідентифікатор завдання (UUID)",
      run: "Переглянути",
      empty:
        "Вставте ідентифікатор завдання та натисніть «Попередній перегляд», щоб відобразити шаблон для реального завдання.",
      admin_only:
        "Попередній перегляд відображеної підказки є дією адміністратора робочого простору. Зверніться до адміністратора робочого простору, якщо вам потрібно побачити її відображеною для конкретного завдання.",
    },
    scope: {
      default: "Стандартний Pi Dash",
      workspace: "Перевизначення робочого простору",
    },
    title: "Підказки",
    subtitle:
    ...
    customize: "Налаштувати для цього робочого простору",
    columns: {
      name: "Назва",
      scope: "Область",
      version: "Версія",
    ...
    list: {
      empty: "Немає доступних шаблонів підказок. Стандартний шаблон Pi Dash буде додано під час наступної міграції.",
    },
    revert: {
      confirm_title: "Повернутися до стандартного Pi Dash?",
      confirm_body:
        "Це архівує ваш шаблон, прив'язаний до робочого простору. Нові запуски агентів у цьому робочому просторі використовуватимуть стандартний Pi Dash, доки ви не створите інше перевизначення.",
      confirm: "Повернути",
    },
    actions: {
      edit: "Редагувати",
  ...
  runners: {
    ...
    approvals: {
      decision_failed: "Не вдалося записати рішення",
      empty: "Немає очікуваних підтверджень.",
      run_meta: "Запуск {runId} · запит {at}",
      expires: "завершується {at}",
      accept_once: "Прийняти один раз",
      accept_for_session: "Прийняти для сесії",
      decline: "Відхилити",
    },
    tabs: {
      runners: "AI Агенти",
    ...
    title: "AI Агенти",
    page_title: "{workspace} - AI Агенти",
    list: {
    ...
    pods: {
      title: "Поди",
      help: "Поди групують ваші раннери. Завдання делегуються поду, і будь-який вільний раннер всередині виконує роботу. Натисніть на плитку, щоб відфільтрувати раннери.",
      load_failed: "Не вдалося завантажити поди",
      tile_aria: "Фільтрувати раннери за подом {name}",
      default_badge: "за замовчуванням",
      runner_count: "{count} раннер(ів)",
      create_tile: "Створити новий под",
      filter_active: "Фільтрація раннерів за подом {name}",
      filter_clear: "Очистити фільтр",
    },
    add_modal: {
      runner_id_label: "ID раннера",
      done: "Готово",
      agent_options: {
      ...
      pod_default_option: "(под за замовчуванням)",
    ...
    runs: {
      cancel_failed: "Не вдалося скасувати запуск",
      columns: {
        started: "Запущено",
        status: "Статус",
        prompt: "Запит",
      ...
      select_run: "Виберіть запуск ліворуч.",
      cancel: "Скасувати запуск",
      prompt: "Запит",
      error: "Помилка",
      done_payload: "Готовий payload",
      events_count: "Події ({count})",
      event_columns: {
        seq: "seq",
        kind: "тип",
        at: "Час",
      },
      cancel_confirm_title: "Скасувати запуск?",
      cancel_confirm_body: "Виконавець зупинить цей запуск, щойно отримає сигнал.",
    },
    create_pod_modal: {
      errors: {
        create_failed: "Не вдалося створити под.",
        project_required: "Виберіть проєкт.",
        load_projects_failed: "Не вдалося завантажити проєкти.",
        name_required: "Ім'я обов'язкове.",
      },
      title: "Створити новий под",
      subtitle: "Поди групують виконавців у межах проєкту. Виберіть проєкт, а потім дайте поду ім'я.",
      project_label: "Проєкт",
      project_placeholder: "Виберіть проєкт",
      project_help: "Проєкт, до якого належить цей под. Ім'я буде доповнено префіксом ідентифікатора проєкту.",
      name_label: "Ім'я",
      name_placeholder: "beefy",
      name_help: "Літери, цифри, дефіси та підкреслення. Префікс проєкту додається автоматично.",
      description_label: "Опис (необов'язково)",
      description_placeholder: "Де працює цей под, для чого він тощо.",
      cancel: "Скасувати",
  ...
  schedulers: {
    toast: {
      created_title: "Планувальник створено",
      created_message: "Адміністратори проєктів тепер можуть встановити його на свої проєкти.",
      create_failed: "Не вдалося створити планувальника.",
      error_title: "Щось пішло не так",
      updated_title: "Планувальник оновлено",
      updated_message: "Наступні запуски використовуватимуть оновлене визначення.",
      update_failed: "Не вдалося оновити планувальника.",
      deleted_title: "Планувальника видалено",
      deleted_message: "Активні прив'язки припинили спрацьовування.",
      delete_failed: "Не вдалося видалити планувальника.",
    },
    title: "Планувальники",
    subtitle:
      "Багаторазові визначення планувальників для цього робочого простору. Встановіть один на проєкт, щоб запускати його запит до проєкту за розкладом cron.",
    new: "Новий планувальник",
    columns: {
      name: "Назва",
      slug: "Слаг",
      source: "Джерело",
    ...
    list: {
      empty: "У цьому робочому просторі ще немає планувальників. Натисніть «Новий планувальник», щоб створити його.",
      installs_count: "{count, plural, one {# встановлення} other {# встановлення}}",
    },
    source: {
      manifest: "Маніфест",
      builtin: "Вбудований",
    ...
    delete: {
      confirm_title: "Видалити планувальник?",
      confirm_body:
        "Це м'яке видалення планувальника. Будь-які активні прив'язки проєктів перестануть спрацьовувати. Слаг стане доступним для повторного створення.",
      confirm: "Видалити",
    },
    form: {
      edit_title: "Редагувати планувальник",
      create_title: "Новий планувальник",
      slug_label: "Слаг",
      errors: {
        slug_required: "Слаг обов'язковий.",
        name_required: "Назва обов'язкова.",
        prompt_required: "Підказка обов'язкова.",
      },
      slug_placeholder: "security-audit",
      slug_help: "Ідентифікатор у нижньому регістрі, що використовується в URL. Не можна змінити після створення.",
      name_label: "Назва",
      name_placeholder: "Security audit",
      description_label: "Опис",
      description_placeholder: "Короткий опис, що відображається у виборі встановлення.",
      prompt_label: "Підказка",
      prompt_placeholder: "Шукайте незакриті проблеми безпеки в цьому проєкті…",
      prompt_help:
        "Базову підказку, яку агент виконує кожного тіка. Контекст проєкту додається під час встановлення, тому залишайте цю підказку незалежною від проєкту.",
      enabled_label: "Увімкнено",
      enabled_help:
        "Вимкнені планувальники не можна встановлювати на нові проєкти, а існуючі прив'язки не спрацьовуватимуть.",
      cancel: "Скасувати",
      saving: "Збереження…",
      save: "Зберегти",
      creating: "Створення…",
      create: "Створити планувальник",
    },
  },
  date: "",
  epics: "",
