...
export default {
  ...
  account_settings: {
    ...
    activity: {
      heading: "活动",
      description: "追踪您在所有项目和工作项中的近期操作和变更。",
    },
    api_tokens: {
      heading: "个人访问令牌",
    ...
    notifications: {
      heading: "电子邮件通知",
      description: "随时了解您订阅的工作项动态。启用此功能以接收通知。",
    },
    preferences: {
      heading: "偏好设置",
      description: "根据您的工作方式自定义应用体验",
    },
  },
  workspace_settings: {
    label: "工作区设置",
    ...
    settings: {
      ...
      billing_and_plans: {
        ...
        view_plans: "查看计划",
        heading: "计费与套餐",
        description: "选择您的套餐，管理订阅，并根据需求增长轻松升级。",
      },
      exports: {
        title: "导出",
        exporting: "导出中",
        ...
        heading: "导出",
        description: "以多种格式导出项目数据，并通过下载链接访问导出历史记录。",
  ...
  project_settings: {
    ...
    states: {
      ...
      members_edit: {
        toast: {
          loading: "正在更新项目设置...",
          success_title: "成功！",
          success_message: "项目设置已更新。",
          error_title: "错误！",
          error_message: "更新项目设置时出现问题。请重试。",
        },
        title: "允许成员编辑状态",
        description: "启用后，项目成员可以添加、编辑、重新排序和删除工作流状态。禁用后，只有管理员可以管理状态。",
      },
      heading: "状态",
    ...
    estimates: {
      ...
      heading: "估算",
      enable_description: "它们有助于传达团队的复杂性和工作量。",
    },
    automations: {
      label: "自动化",
      "auto-archive": {
  ...
  scheduler_bindings: {
    tab_label: "调度器",
    title: "调度器",
    subtitle: "安装在此项目上的调度器。每个安装都会在配置的cron上针对项目触发其提示。",
    install: "安装调度器",
    columns: {
      name: "调度器",
      cron: "计划",
    ...
    toast: {
      updated_title: "安装已更新",
      enabled_message: "调度器已启用——它将在下一个cron周期触发。",
      disabled_message: "调度器已禁用——在重新启用之前不会触发。",
      error_title: "出现问题",
      update_failed: "无法更新安装。",
      updated_message: "后续运行将使用新设置。",
      installed_title: "调度器已安装",
      installed_message: "它将按配置的 cron 触发。",
      install_failed: "无法安装调度器。",
      uninstalled_title: "调度器已卸载",
      uninstalled_message: "在重新安装之前，它不会在此项目上触发。",
      uninstall_failed: "无法卸载调度器。",
    },
    list: {
      empty: "此项目尚未安装任何调度器。点击“安装调度器”从工作区目录添加一个。",
      none_yet: "（从未）",
    },
    actions: {
      disable: "禁用调度器",
    ...
    install_modal: {
      cron_label: "计划 (cron)",
      errors: {
        cron_required: "需要提供 cron 表达式。",
        scheduler_required: "选择一个调度器。",
      },
      cron_placeholder: "0 9 * * *",
      cron_help: "UTC 时区的 5 字段 cron 表达式，例如每天 UTC 09:00 的 ``0 9 * * *``。",
      extra_context_label: "项目上下文（可选）",
      extra_context_placeholder: "此项目的特定备注…",
      extra_context_help: "运行时附加到调度器的基本提示。用于提供工作区提示不应包含的项目特定框架。",
      enabled_label: "已启用",
      enabled_help: "禁用的安装不会在 cron 上触发，直到重新启用。",
      cancel: "取消",
      none_available_title: "没有可用的调度器",
      none_available_body:
        "要么每个工作区调度器都已安装在此项目上，要么您的工作区管理员尚未启用任何调度器。请访问工作区 → 调度器来管理目录。",
      title: "安装调度器",
      scheduler_label: "调度器",
      scheduler_help: "从工作区已启用的调度器中选择。已安装的调度器不会列出。",
      installing: "正在安装…",
      install: "安装",
    },
    uninstall_modal: {
      title: "卸载调度器？",
      body: "调度器将停止在此项目上触发。工作区定义不受影响，之后可以重新安装。",
      confirm: "卸载",
    },
  },
  prompts: {
    detail: {
      loading: "正在加载…",
      not_found: "未找到模板。",
      default_title: "提示模板（Pi Dash 默认）",
      workspace_title: "提示模板（工作区覆盖）",
      default_description: "这是内置的 Pi Dash 默认模板。工作区管理员无法在此编辑——请为你的工作区自定义以覆盖。",
      workspace_description: "你的工作区对 Pi Dash 默认模板的覆盖。编辑会提升版本，并应用于该工作区的下一次代理运行。",
      back: "返回列表",
      body: "模板正文（Jinja + Markdown）",
      unsaved: "未保存的更改",
      save: "保存",
    },
    toast: {
      saved_title: "提示已保存",
      saved_message: "后续的代理运行将使用更新后的提示。",
      save_failed: "无法保存提示。",
      error_title: "出了点问题",
      created_title: "工作区覆盖已创建",
      created_message: "我们复制了当前的 Pi Dash 默认模板。编辑并保存以自定义。",
      customize_failed: "无法创建工作区覆盖。",
      reverted_title: "已恢复为 Pi Dash 默认",
      reverted_message: "此工作区已恢复为共享默认模板。",
      revert_failed: "无法恢复提示。",
    },
    preview: {
      missing_issue_id: "请先输入问题 ID。",
      failed: "渲染失败。",
      title: "预览",
      issue_id_placeholder: "问题ID (UUID)",
      run: "预览",
      empty: "粘贴问题ID并点击“预览”，即可针对真实问题渲染模板。",
      admin_only: "预览渲染后的提示是工作区管理员操作。如需查看针对特定问题的渲染结果，请联系工作区管理员。",
    },
    scope: {
      default: "Pi Dash 默认",
      workspace: "工作区覆盖",
    ...
    title: "提示",
    subtitle: "系统提示模板，在代理运行前针对每个问题渲染。工作区管理员可为此工作区自定义默认模板。",
    customize: "为此工作区自定义",
    columns: {
      name: "名称",
      scope: "范围",
    ...
    list: {
      empty: "没有可用的提示模板。下次迁移时将植入 Pi Dash 默认模板。",
    },
    revert: {
      confirm_title: "恢复为 Pi Dash 默认？",
      confirm_body: "这将归档您的工作区范围模板。此工作区的新代理运行将使用 Pi Dash 默认模板，直到您创建另一个覆盖。",
      confirm: "恢复",
    },
    actions: {
      edit: "编辑",
  ...
  runners: {
    ...
    approvals: {
      decision_failed: "记录决策失败",
      empty: "没有待处理的审批。",
      run_meta: "运行 {runId} · 请求于 {at}",
      expires: "过期于 {at}",
      accept_once: "接受一次",
      accept_for_session: "本次会话接受",
      decline: "拒绝",
    },
    tabs: {
      runners: "AI 代理",
    ...
    list: {
      ...
      how_it_works_body:
        "1. 点击“添加 runner”，选择一个项目 + pod 并提交。云会生成一个一次性注册令牌，绑定到该 runner。\n2. 在将要托管 runner 的机器上，运行显示的 `pidash connect --url ... --token ... --host-label ...` 命令。\n3. 守护进程注册后，runner 将在此处显示为在线。\n\n每个 runner 都有自己的令牌。在主机上注册的第一个 runner 还会引导一个机器令牌，供 `pidash` CLI 用于非 runner 命令。\n\n前提条件：代理 CLI（codex / claude）必须已安装在主机上。",
      ...
      revoke: "撤销",
      delete: "删除",
      empty: "暂无 runner。点击“添加 runner”以创建第一个 runner 专属注册令牌。",
      delete_confirm_title: "删除 runner？",
    ...
    machine_token_note: {
      body: "当 runner 首次在新主机（即新的 ``host_label``）上注册时，云还会签发一个机器令牌，供 ``pidash`` CLI 用于非 runner 命令（issue、comment、state）。同一主机上的后续 runner 将重用该令牌。",
    },
    pods: {
      title: "Pods",
      help: "Pods 将你的运行器分组。问题会委托给一个 Pod，其中的任何空闲运行器都会接手工作。点击一个磁贴以筛选运行器。",
      load_failed: "加载 Pods 失败",
      tile_aria: "按 Pod {name} 筛选运行器",
      default_badge: "默认",
      runner_count: "{count} 个运行器",
      create_tile: "创建新 Pod",
      filter_active: "正在按 Pod {name} 筛选运行器",
      filter_clear: "清除筛选",
    },
    add_modal: {
      runner_id_label: "运行器 ID",
      done: "完成",
      agent_options: {
      ...
      errors: {
        create_failed: "无法生成注册令牌。",
        project_required: "请选择一个项目。",
        load_projects_failed: "无法加载项目。",
        load_pods_failed: "无法加载 Pods。",
      },
      title: "添加运行器",
      subtitle: "为新运行器生成一次性注册令牌。你需要在托管该运行器的机器上运行显示的 `pidash connect` 命令。",
      project_label: "项目",
      project_help: "此运行器将处理的项目。",
      pod_label: "Pod（可选）",
      pod_default_option: "（默认 Pod）",
      pod_help: "默认为项目的默认 Pod。",
      name_label: "名称（可选）",
      name_placeholder: "my-laptop-runner",
      name_help: "如果留空则自动分配，例如 ``runner_001``。",
      host_label_label: "主机标签（可选）",
      host_label_placeholder: "my-laptop",
      host_label_help: "嵌入到建议命令中的自由格式主机名。如果省略该标志，守护进程将替换为实际主机名。",
      working_dir_label: "工作目录（可选）",
      working_dir_placeholder: "本地开发机项目工作目录",
      working_dir_help:
        "守护进程运行代理CLI的本地路径——通常是磁盘上的项目仓库。默认为运行器数据目录下的沙箱，这通常不是你想要的。",
      agent_label: "代理",
      agent_help: "此运行器将驱动哪个AI代理CLI。已嵌入到显示的``pidash connect``命令中。",
      cancel: "取消",
      submitting: "正在铸造…",
      submit: "铸造注册令牌",
      token_warning: "请一次性复制——注册令牌将不再显示。",
      token_instructions: "在将要托管运行器的机器上运行以下命令：",
      copied: "已复制！",
      copy_command: "复制命令",
    },
    runs: {
      ...
      cancel_confirm_title: "取消运行？",
      cancel_confirm_body: "运行器收到信号后将立即停止此运行。",
    },
    create_pod_modal: {
      errors: {
        create_failed: "无法创建pod。",
        project_required: "请选择一个项目。",
        load_projects_failed: "无法加载项目。",
        name_required: "名称为必填项。",
      },
      title: "创建新 Pod",
      subtitle: "Pod 将运行器分组到项目下。选择一个项目，然后为 Pod 命名。",
      project_label: "项目",
      project_placeholder: "选择一个项目",
      project_help: "此 Pod 所属的项目。名称将以项目标识符为前缀。",
      name_label: "名称",
      name_placeholder: "beefy",
      name_help: "字母、数字、短横线和下划线。项目前缀会自动添加。",
      description_label: "描述（可选）",
      description_placeholder: "此 Pod 的运行位置、用途等。",
      cancel: "取消",
      submitting: "正在创建…",
      submit: "创建 Pod",
    },
  ...
  schedulers: {
    toast: {
      created_title: "调度器已创建",
      created_message: "项目管理员现在可以将其安装到他们的项目上。",
      create_failed: "无法创建调度器。",
      error_title: "出了点问题",
      updated_title: "调度器已更新",
      updated_message: "后续运行将使用更新后的定义。",
      update_failed: "无法更新调度器。",
      deleted_title: "调度器已删除",
      deleted_message: "活动绑定已停止触发。",
      delete_failed: "无法删除调度器。",
    },
    title: "调度器",
    subtitle: "此工作区的可重用调度器定义。在项目上安装一个，即可按 cron 计划针对项目运行其提示。",
    new: "新建调度器",
    columns: {
      name: "名称",
      slug: "Slug",
    ...
    list: {
      empty: "此工作区中尚无调度器。点击“新建调度器”创建一个。",
      installs_count: "{count, plural, one {# 次安装} other {# 次安装}}",
    },
    source: {
      manifest: "清单",
      builtin: "内置",
    ...
    delete: {
      confirm_title: "删除调度器？",
      confirm_body: "这将软删除调度器。任何活跃的项目绑定将停止触发。该标识符将可重新使用。",
      confirm: "删除",
    },
    form: {
      edit_title: "编辑调度器",
      ...
      slug_label: "标识符",
      errors: {
        slug_required: "标识符为必填项。",
        name_required: "名称为必填项。",
        prompt_required: "提示词为必填项。",
      },
      slug_placeholder: "security-audit",
      slug_help: "用于 URL 的小写标识符。创建后不可更改。",
      name_label: "名称",
      name_placeholder: "安全审计",
      description_label: "描述",
      description_placeholder: "在安装选择器中显示的简短摘要。",
      prompt_label: "提示词",
      prompt_placeholder: "查找此项目中的突出安全问题……",
      prompt_help: "代理每次运行时使用的基础提示词。安装时会附加每个项目的上下文，因此请保持此提示词与项目无关。",
      enabled_label: "已启用",
      enabled_help: "禁用的调度器无法安装到新项目，现有绑定也不会触发。",
      cancel: "取消",
      saving: "保存中…",
      save: "保存",
      creating: "创建中…",
