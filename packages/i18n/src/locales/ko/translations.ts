...
export default {
  ...
  account_settings: {
    ...
    activity: {
      heading: "활동",
      description: "모든 프로젝트 및 작업 항목에서 최근 활동과 변경 사항을 추적합니다.",
    },
    api_tokens: {
      heading: "개인 액세스 토큰",
      description: "외부 시스템 및 애플리케이션과 데이터를 통합할 수 있는 안전한 API 토큰을 생성합니다.",
    },
    notifications: {
      heading: "이메일 알림",
      description: "구독 중인 작업 항목에 대한 최신 정보를 받아보세요. 이 옵션을 활성화하면 알림을 받을 수 있습니다.",
    },
    preferences: {
      heading: "환경 설정",
      description: "앱 환경을 작업 방식에 맞게 사용자 지정하세요.",
    },
  },
  workspace_settings: {
    label: "작업 공간 설정",
    ...
    settings: {
      ...
      billing_and_plans: {
        ...
        view_plans: "플랜 보기",
        heading: "결제 및 요금제",
        description: "요금제를 선택하고, 구독을 관리하며, 필요에 따라 쉽게 업그레이드하세요.",
      },
      exports: {
        title: "내보내기",
        exporting: "내보내기 중",
        ...
        heading: "내보내기",
        description: "프로젝트 데이터를 다양한 형식으로 내보내고 다운로드 링크가 포함된 내보내기 기록에 액세스하세요.",
        exporting_projects: "프로젝트 내보내는 중",
        format: "형식",
      },
      webhooks: {
        title: "웹훅",
        ...
        description: "프로젝트 이벤트 발생 시 외부 서비스로 알림을 자동화합니다.",
      },
      api_tokens: {
        title: "API 토큰",
        add_token: "API 토큰 추가",
  ...
  project_settings: {
    ...
    states: {
      ...
      members_edit: {
        toast: {
          loading: "프로젝트 설정 업데이트 중...",
          success_title: "성공!",
          success_message: "프로젝트 설정이 업데이트되었습니다.",
          error_title: "오류!",
          error_message: "프로젝트 설정을 업데이트하는 중 문제가 발생했습니다. 다시 시도해 주세요.",
        },
        title: "멤버가 상태를 편집할 수 있도록 허용",
        description:
          "활성화하면 프로젝트 멤버가 워크플로 상태를 추가, 편집, 재정렬 및 삭제할 수 있습니다. 비활성화하면 관리자만 상태를 관리할 수 있습니다.",
      },
      heading: "상태",
      description: "워크플로 상태를 정의하고 사용자 지정하여 작업 항목의 진행 상황을 추적하세요.",
    },
    labels: {
      label_title: "레이블 제목",
      ...
      heading: "레이블",
      description: "작업 항목을 분류하고 정리하기 위해 사용자 지정 레이블을 만듭니다.",
    },
    estimates: {
      label: "추정",
      title: "프로젝트 추정 활성화",
      ...
      heading: "견적",
      enable_description: "이는 팀의 복잡성과 작업량을 전달하는 데 도움이 됩니다.",
    },
    automations: {
      label: "자동화",
      "auto-archive": {
      ...
      heading: "자동화",
      description: "자동화된 작업을 구성하여 프로젝트 관리 워크플로를 간소화하고 수동 작업을 줄이세요.",
    },
    empty_state: {
      labels: {
        title: "레이블 없음",
  ...
  scheduler_bindings: {
    tab_label: "스케줄러",
    title: "스케줄러",
    subtitle: "이 프로젝트에 설치된 스케줄러입니다. 각 설치 시 구성된 cron에 따라 프로젝트에 프롬프트가 실행됩니다.",
    install: "스케줄러 설치",
    columns: {
      name: "스케줄러",
      cron: "일정",
    ...
    toast: {
      updated_title: "설치 업데이트됨",
      enabled_message: "스케줄러가 활성화되었습니다. 다음 cron 틱에서 실행됩니다.",
      disabled_message: "스케줄러가 비활성화되었습니다. 다시 활성화할 때까지 실행되지 않습니다.",
      error_title: "문제가 발생했습니다",
      update_failed: "설치를 업데이트할 수 없습니다.",
      updated_message: "이후 실행 시 새 설정이 사용됩니다.",
      installed_title: "스케줄러 설치됨",
      installed_message: "구성된 cron에 따라 실행됩니다.",
      install_failed: "스케줄러를 설치할 수 없습니다.",
      uninstalled_title: "스케줄러가 제거됨",
      uninstalled_message: "다시 설치될 때까지 이 프로젝트에서 실행되지 않습니다.",
      uninstall_failed: "스케줄러를 제거할 수 없습니다.",
    },
    list: {
      empty:
        "아직 이 프로젝트에 설치된 스케줄러가 없습니다. 워크스페이스 카탈로그에서 추가하려면 “스케줄러 설치”를 클릭하세요.",
      none_yet: "(없음)",
    },
    actions: {
      disable: "스케줄러 비활성화",
    ...
    install_modal: {
      cron_label: "일정 (cron)",
      errors: {
        cron_required: "Cron 표현식이 필요합니다.",
        scheduler_required: "스케줄러를 선택하세요.",
      },
      cron_placeholder: "0 9 * * *",
      cron_help: "UTC 기준 5필드 cron 표현식, 예: 매일 09:00 UTC의 경우 ``0 9 * * *``",
      extra_context_label: "프로젝트 컨텍스트 (선택 사항)",
      extra_context_placeholder: "이 프로젝트에 특화된 메모…",
      extra_context_help:
        "실행 시 스케줄러의 기본 프롬프트에 추가됩니다. 워크스페이스 프롬프트가 포함하지 않아야 할 프로젝트별 프레이밍을 제공하는 데 사용하세요.",
      enabled_label: "활성화됨",
      enabled_help: "비활성화된 설치는 다시 활성화될 때까지 cron에서 실행되지 않습니다.",
      cancel: "취소",
      none_available_title: "사용 가능한 스케줄러 없음",
      none_available_body:
        "모든 워크스페이스 스케줄러가 이미 이 프로젝트에 설치되었거나, 워크스페이스 관리자가 활성화한 스케줄러가 없습니다. 워크스페이스 → 스케줄러로 이동하여 카탈로그를 관리하세요.",
      title: "스케줄러 설치",
      scheduler_label: "스케줄러",
      scheduler_help:
        "워크스페이스에서 활성화된 스케줄러 중에서 선택하세요. 이미 설치된 것은 목록에 표시되지 않습니다.",
      installing: "설치 중…",
      install: "설치",
    },
    uninstall_modal: {
      title: "스케줄러를 제거하시겠습니까?",
      body: "이 프로젝트에서 스케줄러가 더 이상 실행되지 않습니다. 워크스페이스 정의는 영향을 받지 않으며 나중에 다시 설치할 수 있습니다.",
      confirm: "제거",
    },
  },
  prompts: {
    detail: {
      ...
      default_title: "프롬프트 템플릿 (Pi Dash 기본값)",
      workspace_title: "프롬프트 템플릿 (워크스페이스 재정의)",
      default_description:
        "이것은 내장된 Pi Dash 기본값입니다. 워크스페이스 관리자는 여기서 편집할 수 없습니다. 워크스페이스에 맞게 사용자 지정하여 재정의하세요.",
      workspace_description:
        "워크스페이스의 Pi Dash 기본값 재정의입니다. 편집하면 버전이 올라가며 이 워크스페이스의 다음 에이전트 실행에 적용됩니다.",
      back: "목록으로 돌아가기",
      body: "템플릿 본문 (Jinja + Markdown)",
      unsaved: "저장되지 않은 변경 사항",
      save: "저장",
    },
    toast: {
      saved_title: "프롬프트 저장됨",
      saved_message: "이후 에이전트 실행은 업데이트된 프롬프트를 사용합니다.",
      save_failed: "프롬프트를 저장할 수 없습니다.",
      error_title: "문제가 발생했습니다",
      created_title: "워크스페이스 재정의 생성됨",
      created_message: "현재 Pi Dash 기본값을 복사했습니다. 편집하고 저장하여 사용자 지정하세요.",
      customize_failed: "워크스페이스 재정의를 생성할 수 없습니다.",
      reverted_title: "Pi Dash 기본값으로 되돌림",
      reverted_message: "이 워크스페이스는 공유 기본 템플릿으로 돌아갔습니다.",
      revert_failed: "프롬프트를 되돌릴 수 없습니다.",
    },
    preview: {
      missing_issue_id: "먼저 이슈 ID를 입력하세요.",
      failed: "렌더링 실패.",
      title: "미리보기",
      issue_id_placeholder: "이슈 ID (UUID)",
      run: "미리보기",
      empty: "이슈 ID를 붙여넣고 미리보기를 클릭하여 실제 이슈에 대해 템플릿을 렌더링하세요.",
      admin_only:
        "렌더링된 프롬프트를 미리보는 것은 워크스페이스 관리자 전용 작업입니다. 특정 이슈에 대해 렌더링된 결과를 확인해야 하는 경우 워크스페이스 관리자에게 문의하세요.",
    },
    scope: {
      default: "Pi Dash 기본값",
      workspace: "워크스페이스 재정의",
    },
    title: "프롬프트",
    subtitle:
      "에이전트 실행 전 각 이슈에 대해 렌더링되는 시스템 프롬프트 템플릿입니다. 워크스페이스 관리자는 이 워크스페이스의 기본값을 사용자 지정할 수 있습니다.",
    customize: "이 워크스페이스에 맞게 사용자 지정",
    columns: {
      name: "이름",
      scope: "범위",
      version: "버전",
    ...
    list: {
      empty: "사용 가능한 프롬프트 템플릿이 없습니다. 다음 마이그레이션 시 Pi Dash 기본값이 시드됩니다.",
    },
    revert: {
      confirm_title: "Pi Dash 기본값으로 되돌리시겠습니까?",
      confirm_body:
        "이렇게 하면 워크스페이스 범위 템플릿이 보관됩니다. 이 워크스페이스의 새 에이전트 실행은 다른 재정의를 생성할 때까지 Pi Dash 기본값을 사용합니다.",
      confirm: "되돌리기",
    },
    actions: {
      edit: "편집",
  ...
  runners: {
    ...
    approvals: {
      decision_failed: "결정 기록 실패",
      empty: "보류 중인 승인이 없습니다.",
      run_meta: "실행 {runId} · 요청됨 {at}",
      expires: "만료 {at}",
      accept_once: "한 번 수락",
      accept_for_session: "세션 동안 수락",
      decline: "거절",
    },
    tabs: {
      runners: "AI 에이전트",
    ...
    pods: {
      title: "포드",
      help: "포드는 러너를 그룹화합니다. 이슈가 포드에 위임되고, 포드 내의 사용 가능한 러너가 작업을 수행합니다. 타일을 클릭하여 러너를 필터링하세요.",
      load_failed: "포드 로드 실패",
      tile_aria: "포드 {name}별 러너 필터링",
      default_badge: "기본",
      runner_count: "{count} 러너",
      create_tile: "새 포드 만들기",
      filter_active: "포드 {name}별로 러너 필터링 중",
      filter_clear: "필터 지우기",
    },
    add_modal: {
      runner_id_label: "러너 ID",
      done: "완료",
      agent_options: {
    ...
    runs: {
      ...
      empty: "아직 실행이 없습니다.",
      select_run: "왼쪽에서 실행을 선택하세요.",
      cancel: "실행 취소",
      prompt: "프롬프트",
      error: "오류",
      done_payload: "완료 페이로드",
      events_count: "이벤트 ({count})",
      event_columns: {
        seq: "seq",
        kind: "kind",
        at: "at",
      },
      cancel_confirm_title: "실행을 취소하시겠습니까?",
      cancel_confirm_body: "러너가 신호를 받는 즉시 이 실행을 중지합니다.",
    },
    create_pod_modal: {
      errors: {
        create_failed: "팟을 생성할 수 없습니다.",
        project_required: "프로젝트를 선택하세요.",
        load_projects_failed: "프로젝트를 불러올 수 없습니다.",
        name_required: "이름이 필요합니다.",
      },
      title: "새 포드 만들기",
      subtitle: "포드는 프로젝트 아래에 러너를 그룹화합니다. 프로젝트를 선택한 다음 포드에 이름을 지정하세요.",
      project_label: "프로젝트",
      project_placeholder: "프로젝트 선택",
      project_help: "이 포드가 속한 프로젝트입니다. 이름 앞에는 프로젝트 식별자가 붙습니다.",
      name_label: "이름",
      name_placeholder: "beefy",
      name_help: "문자, 숫자, 대시, 밑줄을 사용할 수 있습니다. 프로젝트 접두사는 자동으로 추가됩니다.",
      description_label: "설명(선택 사항)",
      description_placeholder: "이 포드가 실행되는 위치, 용도 등",
      cancel: "취소",
      submitting: "만드는 중…",
      submit: "포드 만들기",
    },
  ...
  schedulers: {
    toast: {
      created_title: "스케줄러 생성됨",
      created_message: "이제 프로젝트 관리자가 프로젝트에 설치할 수 있습니다.",
      create_failed: "스케줄러를 만들 수 없습니다.",
      error_title: "문제가 발생했습니다",
      updated_title: "스케줄러 업데이트됨",
      updated_message: "이후 실행은 업데이트된 정의를 사용합니다.",
      update_failed: "스케줄러를 업데이트할 수 없습니다.",
      deleted_title: "스케줄러 삭제됨",
      deleted_message: "활성 바인딩이 실행을 중지했습니다.",
      delete_failed: "스케줄러를 삭제할 수 없습니다.",
    },
    title: "스케줄러",
    subtitle:
      "이 워크스페이스의 재사용 가능한 스케줄러 정의입니다. 프로젝트에 설치하여 cron으로 프로젝트에 대해 프롬프트를 실행하세요.",
    new: "새 스케줄러",
    columns: {
      name: "이름",
      slug: "슬러그",
    ...
    list: {
      empty: "이 워크스페이스에 아직 스케줄러가 없습니다. “새 스케줄러”를 클릭하여 생성하세요.",
      installs_count: "{count, plural, one {# 설치} other {# 설치}}",
    },
    source: {
      manifest: "매니페스트",
      builtin: "내장",
    ...
    form: {
      ...
      slug_help: "URL에 사용되는 소문자 식별자입니다. 생성 후 변경할 수 없습니다.",
      name_label: "이름",
      name_placeholder: "보안 감사",
      description_label: "설명",
      description_placeholder: "설치 선택기에 표시되는 간단한 요약입니다.",
      prompt_label: "프롬프트",
      prompt_placeholder: "이 프로젝트에서 미해결 보안 문제를 찾습니다…",
      prompt_help:
        "에이전트가 각 틱마다 실행하는 기본 프롬프트입니다. 설치 시 프로젝트별 컨텍스트가 추가되므로 이 프롬프트는 프로젝트에 종속되지 않도록 유지하세요.",
      enabled_label: "활성화",
      enabled_help: "비활성화된 스케줄러는 새 프로젝트에 설치할 수 없으며, 기존 바인딩이 실행되지 않습니다.",
      cancel: "취소",
      saving: "저장 중…",
      save: "저장",
      creating: "만드는 중…",
  ...
  power_k: {
    ...
    preferences_actions: {
      toast: {
        theme: {
          error: "테마 업데이트에 실패했습니다. 다시 시도해 주세요.",
        },
        timezone: {
          success: "시간대가 성공적으로 업데이트되었습니다.",
          error: "시간대 업데이트에 실패했습니다. 다시 시도해 주세요.",
        },
        generic: {
          success: "환경 설정이 성공적으로 업데이트되었습니다.",
          error: "환경 설정 업데이트에 실패했습니다. 다시 시도해 주세요.",
        },
      },
    },
    footer: {
      workspace_level: "워크스페이스 수준",
    },
    page_placeholders: {
      default: "명령어를 입력하거나 검색하세요",
    },
    contextual_actions: {
      cycle: {
        copy_url_toast_success: "사이클 URL이 클립보드에 복사되었습니다.",
        copy_url_toast_error: "사이클 URL을 클립보드에 복사하는 중 오류가 발생했습니다.",
      },
      module: {
  ...
  progress: "",
  customize_navigation: "탐색 사용자 지정",
  personal: "개인",
