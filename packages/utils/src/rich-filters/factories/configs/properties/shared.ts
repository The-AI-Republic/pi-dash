...
import type { IProject, IUserLite, TOperatorConfigMap, TSupportedOperators } from "@apple-pi-dash/types";
import { COMPARISON_OPERATOR, EQUALITY_OPERATOR } from "@apple-pi-dash/types";
// local imports
