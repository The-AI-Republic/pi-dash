...
SPECTACULAR_SETTINGS = {
    ...
    # ========================================================================
    "TITLE": "The Apple Pi Dash REST API",
    "DESCRIPTION": (
        "The Apple Pi Dash REST API\n\n"
        "Visit our quick start guide and full API documentation at "
        "[developers.apple-pi-dash.so](https://developers.apple-pi-dash.so/api-reference/introduction)."
    ),
    "CONTACT": {
        "name": "Apple Pi Dash",
        "url": "https://apple-pi-dash.so",
        "email": "support@apple-pi-dash.so",
    },
    "VERSION": "0.0.1",
    "LICENSE": {
        "name": "GNU AGPLv3",
        "url": "https://github.com/makeapplepidash/apple-pi-dash/blob/preview/LICENSE.txt",
    },
    # ========================================================================
    ...
    # ========================================================================
    "PREPROCESSING_HOOKS": [
        "apple_pi_dash.utils.openapi.hooks.preprocess_filter_api_v1_paths",
    ],
    # ========================================================================
    ...
    "SERVERS": [
        ...
        {"url": "https://api.apple-pi-dash.so", "description": "Production"},
    ],
    # ========================================================================
    # API Tag Definitions
    # ========================================================================
    ...
    "AUTHENTICATION_WHITELIST": [
        "apple_pi_dash.api.middleware.api_authentication.APIKeyAuthentication",
    ],
    # ========================================================================
    ...
    "ENUM_NAME_OVERRIDES": {
        "ModuleStatusEnum": "apple_pi_dash.db.models.module.ModuleStatus",
        "IntakeWorkItemStatusEnum": "apple_pi_dash.db.models.intake.IntakeIssueStatus",
    },
}
