...
# Module imports
from apple_pi_dash.utils.url import is_valid_url
...
INSTALLED_APPS = [
    ...
    # Inhouse apps
    "apple_pi_dash.analytics",
    "apple_pi_dash.app",
    "apple_pi_dash.space",
    "apple_pi_dash.bgtasks",
    "apple_pi_dash.db",
    "apple_pi_dash.utils",
    "apple_pi_dash.web",
    "apple_pi_dash.middleware",
...
MIDDLEWARE = [
    ...
    "apple_pi_dash.authentication.middleware.session.SessionMiddleware",
    ...
    "apple_pi_dash.middleware.request_body_size.RequestBodySizeLimitMiddleware",
    "apple_pi_dash.middleware.logger.APITokenLogMiddleware",
    "apple_pi_dash.middleware.logger.RequestLoggerMiddleware",
]
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "apple_pi_dash.authentication.adapter.exception.auth_exception_handler",
...
# Root Urls
ROOT_URLCONF = "apple_pi_dash.urls"
...
WSGI_APPLICATION = "apple_pi_dash.wsgi.application"
ASGI_APPLICATION = "apple_pi_dash.asgi.application"
...
if os.environ.get("ENABLE_READ_REPLICA", "0") == "1":
    ...
    # Database Routers
    DATABASE_ROUTERS = ["apple_pi_dash.utils.core.dbrouters.ReadReplicaRouter"]
    # Add middleware at the end for read replica routing
    MIDDLEWARE.append("apple_pi_dash.middleware.db_routing.ReadReplicaRoutingMiddleware")
...
STORAGES["default"] = {"BACKEND": "apple_pi_dash.settings.storage.S3Storage"}
...
CELERY_IMPORTS = (
    # scheduled tasks
    "apple_pi_dash.bgtasks.issue_automation_task",
    "apple_pi_dash.bgtasks.exporter_expired_task",
    "apple_pi_dash.bgtasks.file_asset_task",
    "apple_pi_dash.bgtasks.email_notification_task",
    "apple_pi_dash.bgtasks.cleanup_task",
    "apple_pi_dash.license.bgtasks.tracer",
    # management tasks
    "apple_pi_dash.bgtasks.dummy_data_task",
    # issue version tasks
...
SESSION_ENGINE = "apple_pi_dash.db.models.session"
...
CSRF_FAILURE_VIEW = "apple_pi_dash.authentication.views.common.csrf_failure"
