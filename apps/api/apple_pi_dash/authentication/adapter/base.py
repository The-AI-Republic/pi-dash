...
from apple_pi_dash.bgtasks.user_activation_email_task import user_activation_email

# Module imports
from apple_pi_dash.db.models import FileAsset, Profile, User, WorkspaceMemberInvite
...
from apple_pi_dash.utils.exception_logger import log_exception
...
class Adapter:
    ...
    def __init__(self, request, provider, callback=None):
        ...
        self.user_data = None
        self.logger = logging.getLogger("apple_pi_dash.authentication")
