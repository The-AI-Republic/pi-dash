...
app.conf.beat_schedule = {
    ...
    "check-every-five-minutes-to-send-email-notifications": {
        "task": "apple_pi_dash.bgtasks.email_notification_task.stack_email_notification",
        "schedule": crontab(minute="*/5"),  # Every 5 minutes
    },
    "run-every-6-hours-for-instance-trace": {
        "task": "apple_pi_dash.license.bgtasks.tracer.instance_traces",
        "schedule": crontab(hour="*/6", minute=0),  # Every 6 hours
    },
    # Occurs once every day
    "check-every-day-to-delete-hard-delete": {
        "task": "apple_pi_dash.bgtasks.deletion_task.hard_delete",
        "schedule": crontab(hour=0, minute=0),  # UTC 00:00
    },
    "check-every-day-to-archive-and-close": {
        "task": "apple_pi_dash.bgtasks.issue_automation_task.archive_and_close_old_issues",
