...
# Module imports
from apple_pi_dash.utils.html_processor import strip_tags
from apple_pi_dash.db.mixins import SoftDeletionManager
from apple_pi_dash.utils.exception_logger import log_exception
from .project import ProjectBaseModel
from apple_pi_dash.utils.uuid import convert_uuid_to_integer
from .description import Description
from apple_pi_dash.db.mixins import ChangeTrackerMixin
...
class Issue(ProjectBaseModel):
    ...
    def save(self, *args, **kwargs):
        if self.state is None:
            try:
                from apple_pi_dash.db.models import State
