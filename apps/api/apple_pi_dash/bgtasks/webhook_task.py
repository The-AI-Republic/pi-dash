...
from apple_pi_dash.settings.mongo import MongoConnection
...
logger = logging.getLogger("apple_pi_dash.worker")
...
def webhook_send_task(
    ...
    try:
        ...
        headers = {
            ...
            "X-Apple Pi Dash-Delivery": str(uuid.uuid4()),
            "X-Apple Pi Dash-Event": event,
        }
        ...
        if webhook.secret_key:
            ...
            headers["X-Apple Pi Dash-Signature"] = signature
    except Exception as e:
        log_exception(e)
