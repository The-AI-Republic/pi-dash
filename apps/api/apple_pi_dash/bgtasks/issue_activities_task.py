...
# Module imports
from apple_pi_dash.app.serializers import IssueActivitySerializer
from apple_pi_dash.bgtasks.notification_task import notifications
...
from apple_pi_dash.utils.issue_relation_mapper import get_inverse_relation
from apple_pi_dash.utils.uuid import is_valid_uuid
    ...
    if current_instance.get("archived_at") != requested_data.get("archived_at"):
        if requested_data.get("archived_at") is None:
            ...
            if requested_data.get("automation"):
                comment = "Apple Pi Dash has archived the issue"
                new_value = "archive"
            else:
    ...
    if requested_data.get("closed_to") is not None:
        ...
        issue_activities.append(
            IssueActivity(
                ...
                project_id=project_id,
                workspace_id=workspace_id,
                comment="Apple Pi Dash updated the state to ",
                old_identifier=None,
