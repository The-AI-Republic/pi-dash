...
from apple_pi_dash.db.models import Webhook, WebhookLog
from apple_pi_dash.db.models.webhook import validate_domain, validate_schema
...
class WebhookSerializer(DynamicBaseSerializer):
    ...
    def create(self, validated_data):
        ...
        disallowed_domains = ["apple-pi-dash.so"]  # Add your disallowed domains here
        if request:
