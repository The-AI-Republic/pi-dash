...
from apple_pi_dash.bgtasks.work_item_link_task import safe_get, validate_url_ip
...
class TestValidateUrlIp:
    ...
    def test_rejects_private_ip(self):
        with patch("apple_pi_dash.bgtasks.work_item_link_task.socket.getaddrinfo") as mock_dns:
...
class TestSafeGet:
    ...
    @patch("apple_pi_dash.bgtasks.work_item_link_task.requests.get")
    @patch("apple_pi_dash.bgtasks.work_item_link_task.validate_url_ip")
