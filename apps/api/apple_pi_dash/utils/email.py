# SPDX-FileCopyrightText: 2023-present Apple Pi Dash Software, Inc.
# SPDX-License-Identifier: LicenseRef-Apple Pi Dash-Commercial
#
# Licensed under the Apple Pi Dash Commercial License (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
# https://apple-pi-dash.so/legals/eula
#
