...
```python
from apple_pi_dash.utils.openapi.decorators import asset_docs
from apple_pi_dash.utils.openapi.parameters import ASSET_ID_PARAMETER
from apple_pi_dash.utils.openapi.responses import UNAUTHORIZED_RESPONSE
```
...
### Files updated:
- `apple_pi_dash/api/views/asset.py` - All methods use new `@asset_docs` helpers
- `apple_pi_dash/api/views/project.py` - Import updated
- `apple_pi_dash/api/views/user.py` - Import updated  
- `apple_pi_dash/api/views/state.py` - Import updated
- `apple_pi_dash/api/views/intake.py` - Import updated
- `apple_pi_dash/api/views/member.py` - Import updated
- `apple_pi_dash/api/views/module.py` - Import updated
- `apple_pi_dash/api/views/cycle.py` - Import updated
- `apple_pi_dash/api/views/issue.py` - Import updated
- `apple_pi_dash/settings/common.py` - Hook paths updated
- `apple_pi_dash/api/apps.py` - Auth extension import updated
