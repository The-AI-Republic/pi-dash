...
# Module imports
from apple_pi_dash.db.models import BaseModel

ROLE_CHOICES = ((20, "Admin"),)


class InstanceEdition(Enum):
    APPLE_PI_DASH_COMMUNITY = "APPLE_PI_DASH_COMMUNITY"
...
class Instance(BaseModel):
    ...
    edition = models.CharField(max_length=255, default=InstanceEdition.APPLE_PI_DASH_COMMUNITY.value)
