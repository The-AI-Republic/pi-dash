...
from apple_pi_dash.license.models import InstanceConfiguration
from apple_pi_dash.license.api.serializers import InstanceConfigurationSerializer
from apple_pi_dash.license.utils.encryption import encrypt_data
from apple_pi_dash.utils.cache import cache_response, invalidate_cache
from apple_pi_dash.license.utils.instance_value import get_email_configuration
...
class EmailCredentialCheckEndpoint(BaseAPIView):
    def post(self, request):
        ...
        subject = "Email Notification from Apple Pi Dash"
        message = "This is a sample email notification sent from Apple Pi Dash application."
        # Send the email
        try:
