...
_ENV_INFRA = {
    ...
    "MANAGED_RUNNER_QUEUED_MAX_AGE_SECS": 43200,
    "MANAGED_RUNNER_GRACEFUL_STOP_SECS": 30,
    "MANAGED_RUNNER_SWEEP_INTERVAL_SECONDS": 300,
    ...
    "CLOUD_AGENT_BLOCK_PRIVATE_URLS": "true",
    # Sessions / cookies
