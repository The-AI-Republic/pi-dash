...
import { AccentureLogo, DolbyLogo, SonyLogo, ZerodhaLogo } from "@pi-dash/propel/icons";
...
export function AuthFooter() {
  return (
    <div className="flex flex-col items-center gap-6">
      <span className="text-13 whitespace-nowrap text-tertiary">Join 10,000+ teams building with Pi Dash</span>
