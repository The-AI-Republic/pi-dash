...
const MORE_ITEM_KEYS = ["projects", "runners", "prompts", "schedulers", "ai-dev-machines", "analytics", "archives"];
...
const MORE_PATH_SEGMENTS = ["/runners", "/prompts", "/schedulers", "/ai-dev-machines", "/analytics", "/archives"];
  ...
  return (
    <Disclosure as="div" className="flex flex-col" defaultOpen={!!isMoreMenuOpen}>
      <div className="group flex w-full items-center justify-between rounded-sm px-2 py-1.5 text-placeholder hover:bg-layer-transparent-hover">
        ...
        >
          <span className="text-13 font-semibold">{t("More")}</span>
        </Disclosure.Button>
