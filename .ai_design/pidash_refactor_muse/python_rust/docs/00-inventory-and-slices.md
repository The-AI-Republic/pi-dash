...
| D-12 | 9     | orchestration engine                                  | — (signals)                                     | `orchestration/` (incl. `blockers.py`, `done_signal.py`, `relations.py`, `workpad.py`; `wake.py` once PDASHOSS01-198 is in the `Ported from` sha), `core/` remainder                                                                                                                         | reads `db`, `runner`                                              | `tests/unit/orchestration`                                                    | `full`                                                                                     |
